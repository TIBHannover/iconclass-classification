...
TEST_PATH="/nfs/data/reflectai/iconclass/unify/artdl/test/msg/"
TEST_ANNOTATION_PATH="/nfs/data/reflectai/iconclass/unify/artdl/test.jsonl"
...
PREDICTION_PATH="unify_artdl_fine_test_prediction_prob_chain_5000.h5"
RESULT_PATH="unify_artdl_fine_test_ap_prob_chain_5000.jsonl"


MODEL_PATH="/data/iart/output/reflectai/iconclass/"
OUTPUT_PATH="/data/iart/output/reflectai/iconclass/"
# clip

runs=( \
    artdl_fine_icarus_unify_onto_fine_4x64_batch_4x64_packed_blib_instruction/230624/ \
    # unify_onto_fine_4x64_batch_4x64_packed_blib_instruction/230617/ \
)
...
do	
    ...
    --resume_from_checkpoint ${MODEL_PATH}/${run}/epoch=*-step=4999.ckpt \
