...
PREDICTION_PATH="unify_artdl_fine_test_prediction_prob_chain_500.h5"
RESULT_PATH="unify_artdl_fine_test_ap_prob_chain_500.jsonl"
...
do	
    ...
    --resume_from_checkpoint ${MODEL_PATH}/${run}/epoch=*-step=499.ckpt \
