...
TEST_PATH="/nfs/data/reflectai/iconclass/unify/brill/all/msg/"
TEST_ANNOTATION_PATH="/nfs/data/reflectai/iconclass/unify/brill/all.jsonl"
...
PREDICTION_PATH="unify_brill_all_prediction_prob_chain_40000.h5"
RESULT_PATH="unify_brill_all_ap_prob_chain.jsonl"
...
runs=( \
    unify_unify_yolo_fine_4x64_batch_4x64_packed_blib_instruction/230617/ \
)
