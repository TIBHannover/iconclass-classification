...
runs=( \
    ...
    /nfs/home/springsteinm/output/reflectai/iconclass/unify_onto_fine_4x64_batch_4x64_packed_blib_instruction/230617/ \
)
...
do	
    ...
    --test_annotation_path /nfs/data/reflectai/iconclass/unify/iconclass/test.jsonl --use_probability_chain \
    ...
    --ontology_path /nfs/data/reflectai/iconclass/unify/ontology.jsonl --train_merge_one_hot
