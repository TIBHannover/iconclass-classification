...
--load_clip_from_checkpoint  /nfs/home/springsteinm/output/iart/iconclass/clip_batch_4x64_packed/220705/epoch=0-step=39999.ckpt \
...
--output_path /nfs/home/springsteinm/output/iart/iconclass/cos_fine_32_batch_4x64_packed/230610 \
--use_wandb --wandb_name cos_fine_32_batch_4x64_packed/230610 \
...
--val_path /nfs/data/iart/iconclass/data_202002/packed/val/msg/ \
--val_annotation_path /nfs/data/iart/iconclass/data_202002/val.jsonl \
--output_path /nfs/home/springsteinm/output/iart/iconclass/clip_fine_32_batch_4x64_packed/230610 \
--use_wandb --wandb_name clip_fine_32_batch_4x64_packed/230610 \
--lr 1e-5 --local_loss --gather_with_grad --log_every_n_steps 1 --sched_type cosine --lr_init 0.0 --lr_rampup 500 --lr_rampdown 41000 \
--train_size 224 \
--use_center_crop \
--val_size 224 \
...
--val_path /nfs/data/iart/iconclass/data_202002/packed/val/msg/ \
--val_annotation_path /nfs/data/iart/iconclass/data_202002/val.jsonl \
--output_path /nfs/home/springsteinm/output/iart/iconclass/flat_fine_32_batch_4x64_packed/230610 \
--use_wandb --wandb_name flat_fine_32_batch_4x64_packed/230610 \
--lr 1e-5 --local_loss --gather_with_grad --log_every_n_steps 1 --sched_type cosine --lr_init 0.0 --lr_rampup 500 --lr_rampdown 41000 \
--train_size 224 \
--use_center_crop \
--val_size 224 \
...
--val_path /nfs/data/iart/iconclass/data_202002/packed/val/msg/ \
--val_annotation_path /nfs/data/iart/iconclass/data_202002/val.jsonl \
--output_path /nfs/home/springsteinm/output/iart/iconclass/yolo_fine_32_batch_4x64_packed/230610 \
--use_wandb --wandb_name yolo_fine_32_batch_4x64_packed/230610 \
--lr 1e-5 --local_loss --gather_with_grad --log_every_n_steps 1 --sched_type cosine --lr_init 0.0 --lr_rampup 500 --lr_rampdown 41000 \
--train_size 224 \
--use_center_crop \
--val_size 224 \
...
--val_path /nfs/data/iart/iconclass/data_202002/packed/val/msg/ \
--val_annotation_path /nfs/data/iart/iconclass/data_202002/val.jsonl \
--output_path /nfs/home/springsteinm/output/iart/iconclass/onto_fine_32_batch_4x64_packed/230610 \
--use_wandb --wandb_name onto_fine_32_batch_4x64_packed/230610 \
--lr 1e-5 --local_loss --gather_with_grad --log_every_n_steps 1 --sched_type cosine --lr_init 0.0 --lr_rampup 500 --lr_rampdown 41000  \
--train_size 224 \
--use_center_crop \
--val_size 224 \
